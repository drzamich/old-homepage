...
document.write(
  new Array(
    ...
    '<h4>No document type declaration; implying "&lt;!DOCTYPE HTML SYSTEM&gt;"</h4><p>Taki błąd oznacza, że na początku dokumentu nie zadeklarowano w jakim typie języka HTML napisana jest strona WWW, czyli <span class="i">Doctype</span>. Aby go naprawić należy to zrobić. Jeśli nie wiesz jaki <span class="i">Doctype</span> zadeklarować, przeczytaj <a href="porady-1.html">porady XHTML</a>.</p>',
